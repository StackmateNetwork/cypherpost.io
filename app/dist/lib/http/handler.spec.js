                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            (0, chai_1.expect)(response).to.have.property("code");
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            e = { a: "nice", little: "stringified", json: "json" };
                            return [4 /*yield*/, handler.filterError((0, e_1.handleError)(e), winston_1.r_500, request_data)];
                        case 1:
                            response = _a.sent();
                            console.log(response);
                            (0, chai_1.expect)(response).to.have.property("code");
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            (0, chai_1.expect)(response).to.have.property("code");
                            (0, chai_1.expect)(response).to.have.property("message");
                            (0, chai_1.expect)(response.message['error'].length).to.equal(2);
                            return [2 /*return*/];
                    }
                });
            });

...
// ------------------ '(◣ ◢)' ---------------------
var KEY_PATH = "".concat(process.env.HOME, "/.keys");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    if (!fs.existsSync("".concat(KEY_PATH, "/").concat(KEY_NAME, ".pem"))) return [3 /*break*/, 2];
                    private_key = fs
                        .readFileSync("".concat(KEY_PATH, "/").concat(KEY_NAME, ".pem"))
                        .toString("ascii");
                    message = "".concat(status_code, "-").concat(headers["x-s5-id"], "-").concat(headers["x-s5-time"]);
                    sign = crypto.createSign("RSA-SHA256");
                    sign.update(message);
                    sign.end();
                    signature = sign.sign({ key: private_key }, 'base64');
                ...
                case 2:
                    ...
                    return [2 /*return*/, (0, e_1.handleError)({
                            code: 500,
                ...
                case 4:
                    ...
                    return [2 /*return*/, (0, e_1.handleError)(e_3)];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                ...
                public_key = fs
                    .readFileSync("".concat(KEY_PATH, "/").concat(KEY_NAME, ".pub"))
                    .toString("ascii");
                message = "".concat(status_code, "-").concat(headers["x-s5-id"], "-").concat(headers["x-s5-time"]);

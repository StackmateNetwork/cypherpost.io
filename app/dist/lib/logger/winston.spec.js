...
var LOG_FILE = "".concat(process.env.HOME, "/winston/logs/moltres.log");
// ------------------ ┌∩┐(◣_◢)┌∩┐ ------------------
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, exec_prom("tail -2 ".concat(LOG_FILE))];
                        case 1:
                            out = _a.sent();
                            exists = fs_1.default.existsSync(LOG_FILE);
                            (0, chai_1.expect)(out.stdout.includes(message)).to.equal(false);
                            return [2 /*return*/];
                    }
                });
            });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            out = _a.sent();
                            (0, chai_1.expect)(out.stdout.includes(message)).to.equal(true);
                            return [2 /*return*/];
                    }
                });
            });

...
var signature = "";
        ...
        it("SHOULD return a hmac sha256 signature of a message using an rsa private key", function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    (0, chai_1.expect)(response).to.equal(signature);
                    return [2 /*return*/];
                });
            });
        });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            (0, chai_1.expect)(response).to.have.property("privkey");
                            (0, chai_1.expect)(response).to.have.property("pubkey");
                            return [2 /*return*/];
                    }
                });
            });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            (0, chai_1.expect)(iv.length).to.equal(32);
                            return [2 /*return*/];
                    }
                });
            });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            response = _a.sent();
                            (0, chai_1.expect)(response).to.equal(message);
                            return [2 /*return*/];
                    }
                });
            });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            response = _a.sent();
                            (0, chai_1.expect)(response['name']).to.equal("501");
                            return [2 /*return*/];
                    }
                });
            });

...
var S5UID = /** @class */ (function () {
    ...
    S5UID.prototype.createUserID = function () {
        return "s5id".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    S5UID.prototype.createInternalTxidPair = function () {
        var common = to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH);
        return {
            sender: "s5sen".concat(common),
            receiver: "s5rec".concat(common)
        };
    };
    S5UID.prototype.createRandomID = function (length) {
        return "".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, length));
    };
    S5UID.prototype.createSessionID = function () {
        return "s5sh".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    S5UID.prototype.createIDVSReference = function (prefix) {
        return "s5iv".concat(prefix).concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    S5UID.prototype.createAccountID = function () {
        return "s5wl".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    S5UID.prototype.createBuyOrderID = function () {
        return "s5by".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    S5UID.prototype.createSellOrderID = function () {
        return "s5sl".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    S5UID.prototype.createTxID = function () {
        return "s5tx".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    S5UID.prototype.createResponseID = function () {
        return "s5rs".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    S5UID.prototype.createAffiliateCode = function () {
        return "s5af".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    S5UID.prototype.createFloatWalletID = function () {
        return "s5fw".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    S5UID.prototype.createColdWalletID = function () {
        return "s5cl".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    S5UID.prototype.createPostCode = function () {
        return "s5p".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    S5UID.prototype.createBTCWithdrawID = function () {
        return "s5wb".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    S5UID.prototype.createEURWithdrawID = function () {
        return "s5we".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    S5UID.prototype.createXFloatTxID = function () {
        return "s5fx".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    S5UID.prototype.createFiatReference = function () {
        return "s5fr".concat(to_b58(Buffer.from((0, uuid_1.v4)().replace(/-/g, "")), MAP).slice(0, LENGTH));
    };
    return S5UID;
}());
exports.S5UID = S5UID;

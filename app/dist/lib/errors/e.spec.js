    ...
    describe("handleError(string code)", function () {
        it("SHOULD convert a provided message object or string into an approriately named Error type", function () {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    response = (0, e_1.handleError)(e2);
                    // console.log({response})
                    (0, chai_1.expect)(response['name']).to.equal("430");
                    return [2 /*return*/];
                });
            });
        });
    ...
    describe("handleError(number code)", function () {
        it("SHOULD convert a provided message object or string into an approriately named Error type", function () {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    response = (0, e_1.handleError)(e3);
                    // console.log({response})
                    (0, chai_1.expect)(response['name']).to.equal("420");
                    return [2 /*return*/];
                });
            });
        });
    ...
    describe("handleError(Error as message)", function () {
        it("SHOULD convert a provided message object or string into an approriately named Error type", function () {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    response = (0, e_1.handleError)(e5);
                    // console.log({response})
                    (0, chai_1.expect)(response['name']).to.equal("404");
                    return [2 /*return*/];
                });
            });
        });
